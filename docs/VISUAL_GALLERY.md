...
This repository includes a small set of public-facing visuals selected to demonstrate spatial diagnostics, crop-threshold behavior, and workflow design.

## Included Figures

| File | What it demonstrates | Public-release role |
|---|---|---|
...
The visual set is meant to signal three capabilities relevant to agricultural economics and remote sensing roles:

- converting climate archives into crop-relevant exposure metrics;
- validating model products against a benchmark reanalysis;
- communicating spatial and crop-specific diagnostics clearly.
