...
DATA_PATHS <- list(
  era5    = file.path(BASE_PATH, "data/processed/era5/europe_edd_adm1_seasonal_panel.parquet"),
  esgf    = file.path(BASE_PATH, "data/processed/cmip6_raw/europe_edd_adm1_seasonal_panel.parquet"),
  biasadj = file.path(BASE_PATH, "data/processed/cmip6_bias_adjusted/europe_edd_adm1_seasonal_panel.parquet")
)

SHAPEFILE_PATH <- file.path(BASE_PATH, "data/external/shapefiles/gadm41_EUR_shp/gadm41_EUR_1.shp")
